...
Revision ID: 20e3c9e02a7f
Revises: c670b5986bd8
Create Date: 2024-04-12 19:06:29.435014
...
revision = '20e3c9e02a7f'
down_revision = 'c670b5986bd8'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('body', sa.VARCHAR(length=120), nullable=False),
    sa.Column('timestamp', sa.DATETIME(), nullable=False),
    sa.Column('user_id', sa.INTEGER(), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
